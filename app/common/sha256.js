                    ...
                    this.inst = (function (H) {
                        function v(c, a, b) {
                            ...
                            this.setHMACKey = function (a, b, d) {
                                ...
                                for (a = 0; a <= d; a += 1)
                                    q[a] = b[a] ^ 909522486, t[a] = b[a] ^ 1549556828;
                                h = F(q, h);
                                g = m;
                                k = !0;
                            };
                        ...
                        function J(c, a, b) {
                            ...
                            for (d = 0; d < c.length; d += 1)
                                a = c.charCodeAt(d), h = d + f, e = h >>> 2, g.length <= e && g.push(0), g[e] |= a << 8 * (3 - h % 4);
                        ...
                        function K(c, a, b) {
                            ...
                            for (e = 0; e < c.length; e += 4) {
                                l = c.substr(e, 4);
                                for (h = n = 0; h < l.length; h += 1)
                                    f = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(l[h]), n |= f << 18 - 6 * h;
                                for (h = 0; h < l.length - 1; h += 1) {
                                    m = d + a;
                                    for (f = m >>> 2; g.length <= f;)
                                        g.push(0);
                        ...
                        function C(c, a) {
                            ...
                            for (d = 0; d < g; d += 1)
                                f = c[d >>> 2] >>> 8 * (3 - d % 4), b += "0123456789abcdef".charAt(f >>> 4 & 15) + "0123456789abcdef".charAt(f & 15);
                            return a.outputUpper ? b.toUpperCase() : b;
                        }
                        function D(c, a) {
                            var b = "", g = 4 * c.length, d, f, e;
                            for (d = 0; d < g; d += 3)
                                for (e = d + 1 >>> 2, f = c.length <= e ? 0 : c[e], e = d + 2 >>> 2, e = c.length <= e ? 0 : c[e], e = (c[d >>> 2] >>> 8 * (3 - d % 4) & 255) << 16 | (f >>> 8 * (3 - (d + 1) % 4) & 255) << 8 | e >>> 8 * (3 - (d + 2) % 4) & 255, f = 0; 4 > f; f += 1)
                        ...
                        function E(c) {
                            ...
                            for (g = 0; g < b; g += 1)
                                d = c[g >>> 2] >>> 8 * (3 - g % 4) & 255, a += String.fromCharCode(d);
                            return a;
                        }
                        function B(c) {
                        ...
                        function A(c, a, b) {
                            ...
                            if ("SHA-224" === b || "SHA-256" === b)
                                r = 64, t = 1, D = Number, q = R, v = S, u = T, y = P, w = Q, z = N, A = O, C = M, B = L, E = G;
                            else
                                throw Error("Unexpected error in SHA-2 implementation");
                            b = a[0];
                            g = a[1];
                            ...
                            l = a[7];
                            for (p = 0; p < r; p += 1)
                                16 > p ? (k = p * t, m = c.length <= k ? 0 : c[k], k = c.length <= k + 1 ? 0 : c[k + 1], x[p] = new D(m, k)) : x[p] = v(w(x[p - 2]), x[p - 7], y(x[p - 15]), x[p - 16]), m = u(l, A(e), B(e, h, n), E[p], x[p]), k = q(z(b), C(b, g, d)), l = n, n = h, h = e, e = q(f, m), f = d, d = g, g = b, b = q(m, k);
                            a[0] = q(b, a[0]);
                            a[1] = q(g, a[1]);
                            a[2] = q(d, a[2]);
                            a[3] = q(f, a[3]);
