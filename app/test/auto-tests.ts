...
export class AutoTests {
	...
	pingWillSucceed(client:CirtsClient,testRunner){
	...
	personSearchWillSucceedWithValidParameters(client:CirtsClient,testRunner:AutoTestRunner){
	...
	personSearchWillSucceedWithValidParametersHashLengthWeird(client:CirtsClient, testRunner:AutoTestRunner) {
		var testName = "Person search will succeed with valid parameters";
	...
	personSearchWillSucceedWithValidParametersIndividual(client:CirtsClient, testRunner:AutoTestRunner) {
		var testName = "Person search will succeed with valid parameters";
	...
	personSearchWillSucceedWithValidParametersCarer(client:CirtsClient, testRunner:AutoTestRunner) {
		var testName = "Person search will succeed with valid parameters";
	...
	personSearchWillSucceedWithValidParametersWorker(client:CirtsClient, testRunner:AutoTestRunner) {
		var testName = "Person search will succeed with valid parameters";
