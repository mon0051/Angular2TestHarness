    ...
    return {
        ...
        execute: function() {
            AutoTests = (function () {
                ...
                AutoTests.prototype.pingWillSucceed = function (client, testRunner) {
                    var testName = "ping test";
                    var query = "ping";
                ...
                AutoTests.prototype.personSearchWillSucceedWithValidParameters = function (client, testRunner) {
                    var testName = "Person search will succeed with valid parameters";
                    var query = "person?givenNames=bartra&personType=Client";
                    auto_test_runner_1.AutoTestHelpers.GetWillSucceed(query, testName, testRunner, client);
                };
                AutoTests.prototype.personSearchWillSucceedWithValidParametersHashLengthWeird = function (client, testRunner) {
                    var testName = "Person search will succeed with valid parameters";
                    var query = "person?givenNames=bartram&personType=Client";
                    auto_test_runner_1.AutoTestHelpers.GetWillSucceed(query, testName, testRunner, client);
                };
                AutoTests.prototype.personSearchWillSucceedWithValidParametersIndividual = function (client, testRunner) {
                    var testName = "Person search will succeed with valid parameters";
                    var query = "person?givenNames=bartra&personType=Individual";
                    auto_test_runner_1.AutoTestHelpers.GetWillSucceed(query, testName, testRunner, client);
                };
                AutoTests.prototype.personSearchWillSucceedWithValidParametersCarer = function (client, testRunner) {
                    var testName = "Person search will succeed with valid parameters";
                    var query = "person?givenNames=bartra&personType=Carer";
                    auto_test_runner_1.AutoTestHelpers.GetWillSucceed(query, testName, testRunner, client);
                };
                AutoTests.prototype.personSearchWillSucceedWithValidParametersWorker = function (client, testRunner) {
                    var testName = "Person search will succeed with valid parameters";
                    var query = "person?givenNames=bartra&personType=Worker";
                    auto_test_runner_1.AutoTestHelpers.GetWillSucceed(query, testName, testRunner, client);
                };
                return AutoTests;
            }());
